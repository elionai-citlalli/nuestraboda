...
//         hour = minute * 60,
//         day = hour * 24;
//   let birthday = "Jul 19, 2025 12:00:00",
...
(function () {
    ...
    let weddingDate = "Jul 19, 2025 12:00:00",
        countDown = new Date(weddingDate).getTime(),
        headline = document.querySelector("#countdown h2");
    ...
    setInterval(function () {
      ...
      if (distance >= 0) {
        // Antes de la boda: cuenta regresiva normal
        headline.innerText = "Nos casaremos en";
        document.getElementById("days").innerText = Math.floor(distance / day);
        document.getElementById("hours").innerText = Math.floor((distance % day) / hour);
        document.getElementById("minutes").innerText = Math.floor((distance % hour) / minute);
        document.getElementById("seconds").innerText = Math.floor((distance % minute) / second);
      } else {
        // Después de la boda: cuenta hacia adelante
        headline.innerText = "Nos casamos hace";
        let timePassed = now - countDown;
        document.getElementById("days").innerText = Math.floor(timePassed / day);
        document.getElementById("hours").innerText = Math.floor((timePassed % day) / hour);
        document.getElementById("minutes").innerText = Math.floor((timePassed % hour) / minute);
        document.getElementById("seconds").innerText = Math.floor((timePassed % minute) / second);
      }
